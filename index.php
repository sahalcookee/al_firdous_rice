...
<body>
    ...
    ?>
    <!-- banner section  -->
    <section class="mt-lg-4 mt-2 pt-5 pt-lg-0 pb-0 pb-lg-5">
        <div class="container">
    ...
    <section class="py-5 mb-0 mb-lg-5 position-relative">
        <img class="position-absolute h-s1-decor-1 d-none d-md-block" src="assets/images/h-s1-rice-1.png" alt="">
                    ...
                    <div class="col-12">
                        <div class="rounded rounded-5 h-s1-yellow-div yellow-bg position-relative">
                            <div class="text-center">
                                ...
                                <div class="mt-4 mt-md-5 mb-4 mb-md-0">
                            ...
                            <img class="position-absolute start-0 bottom-0 h-s1-grain-1 d-none d-md-block" src="assets/images/h-s1-grain-img.png" alt="">
                            <img class="position-absolute end-0 bottom-0 h-s1-grain-2 d-none d-md-block" src="assets/images/h-s1-grain-img.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- section 2  -->
    <section class="py-5 pt-0 pt-md-5 mb-0 mb-lg-5">
        <div class="container-fluid p-0 position-relative">
            <img class="position-absolute h-s2-rice-pack d-none d-md-block" src="assets/images/abusalam.png" alt="">
    ...
    <!-- section 3  -->
    <section class="py-5 pt-0 pt-md-5">
        <div class="container-fluid p-0">
            <div class="text-center position-relative mb-0 mb-md-5 pb-3">
                <img class="position-absolute h-s3-grain d-none d-md-block" src="assets/images/h-s1-grain-img.png" alt="">
                <h2 class="main-h fw-bold blk-prime h-s1-h mx-auto max-w">Take a Look at What We Offer</h2>
                <img class="mt-3 img-fluid h-decor" src="assets/images/h-decor.png" alt="">
            </div>
            <div class="brown-bg py-5 mt-0 mt-md-5 position-relative h-s3-div">
                <img class="position-absolute h-s3-rice-pack-1 d-none d-lg-block" src="assets/images/akbarcityxxl.png" alt="">
                <img class="position-absolute h-s3-rice-pack-2 d-none d-lg-block" src="assets/images/alfirdous.png" alt="">
                <div class="container">
                    <p class="body-p fw-normal text-white text-center fs-4 mt-0 mt-md-5">Rice is a staple food for millions of people around the world. It provides a source of carbohydrates, vitamins, and minerals that are essential for human health. However, ensuring access to rice can be challenging, especially in regions where it is not locally produced or where supply chains are weak. This is where rice companies play a crucial role in ensuring the availability and accessibility of rice produts.</p>
        ...
        <div class="container text-center">
            ...
            <div class="brown-bg py-4 px-2 px-md-3 px-lg-5 rounded-5 position-relative">
                ...
                <div class="px-2 px-md-3 px-md-4 px-lg-5">
                    ...
                    <p class="body-p fw-normal text-white fs-4 mb-0 mb-md-5">Over time, the biryani evolved and became popular across different regions of India, with each region adding its unique flavor and ingredients. For instance, the biryani in Hyderabad is known for its spicy and tangy taste, while the biryani in Lucknow is more delicate and fragrant.</p>
                </div>
                <div class="my-5">
                    <a class="d-inline-flex bg-white rounded-pill px-4 py-3 text-decoration-none align-items-center text-black h-s1-butn" href="#">
                        <p class="body-p fw-semibold fs-5 m-0">Read our story</p>
    ...
    <!-- section-8  -->
    <section class="mb-0 position-relative h-s3-div pt-0 pt-md-5">
        ...
        <div class="brown-bg h-s8-lower-div mt-5 d-none d-sm-block"></div>
    </section>
                    ...
                    <div class="offset-lg-5 col-lg-7">
                        <div class="h-s9-div brown-bg p-2 p-md-3 p-lg-5 rounded-start-5 position-relative">
                            ...
                            <div class="h-s9-head-div">
                                <div class="text-center">
                                    <h2 class="main-h2 fw-bold fs-1 m-0 text-white text-uppercase pt-4 pt-lg-0">Grains of hope</h2>
                                    <img class="mt-3 img-fluid h-decor" src="assets/images/h-decor.png" alt="">
                                </div>
                            </div>
                            <p class="body-p px-2 fw-normal text-white fs-3 mt-2 mt-md-5 mb-5 pb-5">A drive to bring a smile to every face and food on every plate. During the time of the pandemic, ‘Grains of Hope’ an initiative India Gate Foods was initiated for Mothers by ensuring the maximum number, receiving rice supply and benefited many families across the country.</p>
                            <img class="position-absolute end-0 bottom-0 h-s9-decor-img" src="assets/images/h-s9-grain-decor.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
