        ...
        <div class="d-none d-lg-block">
            <div class="desk-nav rounded-pill position-relative p-5 pb-3">
                ...
                <div class="d-flex body-p mt-4 justify-content-evenly">
                    ...
                    <a class="blk-prime text-decoration-none px-4 py-2 rounded-pill bg-white border border-2 fs-5 nav-a <?php active('products'); ?>"
        ...
        <div class="d-block d-lg-none">
            <nav class="navbar resp-nav fixed-top">
                <div class="container-fluid">
                    <a class="navbar-brand ms-3" href="index"><img class="w-75 resp-nav-logo-1"
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-header">
                            <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><img class="w-50"
                                    src="assets/images/logo.svg" alt=""></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="offcanvas"
                                aria-label="Close"></button>
                        </div>
                        <div class="offcanvas-body">
                            <ul
                                class="navbar-nav justify-content-end flex-grow-1 pe-3 text-center fs-5 body-p fw-medium">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link rounded-5 <?php active('products'); ?>"
                                        href="products">Products</a>
                                </li>
                                <li class="nav-item">
...
<!-- floating-btn-call  -->
<div class="floating_btn floating_btn-call bounce">
    <a href="tel:+91 85900 07685">
        <div class="contact_icon contact_icon-call">
            <img src="assets/images/call-float.svg" alt="Call Now">
        </div>
    </a>
</div>
<!-- floating-btn-whatsapp  -->
<div class="floating_btn">
    <a target="_blank" href="https://wa.me/+918590007685">
        <div class="contact_icon">
            <img src="assets/images/whatsapp-float.svg" alt="WhatsApp">
        </div>
    </a>
</div>