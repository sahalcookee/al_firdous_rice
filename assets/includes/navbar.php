            ...
            <div class="d-none d-lg-block">
                <div class="desk-nav rounded-pill position-relative p-5 pb-3">
                    ...
                    <div class="d-flex body-p mt-4 justify-content-evenly">
                        <a class="blk-prime text-decoration-none px-4 py-2 rounded-pill bg-white border border-2 fs-5 nav-a" href="#">Home</a>
                        <a class="blk-prime text-decoration-none px-4 py-2 rounded-pill bg-white border border-2 fs-5 nav-a" href="#">About</a>
                        <a class="blk-prime text-decoration-none px-4 py-2 rounded-pill bg-white border border-2 fs-5 nav-a" href="#">Brand</a>
                        <a class="blk-prime text-decoration-none px-4 py-2 rounded-pill bg-white border border-2 fs-5 nav-a" href="#">Contact</a>
                    </div>
                </div>
            </div>
            <!-- responsive-nav -->
