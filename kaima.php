                    ...
                    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-touch="true" data-bs-ride="carousel">
                        <div class="carousel-inner rounded-5">
                            <div class="carousel-item active">
                                <img src="assets/images/product-inner-aliflaila-1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="assets/images/product-inner-qilaf-jeerakam-brown-1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="assets/images/product-inner-akbarcity-jeera-1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="assets/images/product-inner-alqilal-jeerakam-1.jpg" class="d-block w-100" alt="...">
                            </div>
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="pb-3">
                        <div class="text-start text-md-end prod-inner-s2-col2-h-div pb-0 pb-md-4 pt-5 pt-lg-0">
                            <h2 class="main-h2 fw-bold h-s1-h text-uppercase">kaima</h2>
